...
function EchoSettings() {
  ...
  this.gui.innerHTML = `
    ...
    <div id="eg-content">
      ...
      <div class="eg-panel active" id="panel-opening">
        ...
        ${toggle('Fullscreen', 'opt-fullscreen')}
      </div>
  ...
  const wireToggles = () => {
    ...
    const fsToggle = this.gui.querySelector('#opt-fullscreen');
    if (fsToggle) {
      const syncFs = () => { try { fsToggle.checked = !!document.fullscreenElement; } catch(e){} };
